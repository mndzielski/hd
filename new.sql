...
--------------------------------------------------------
  ...
  CREATE TABLE "HD2018"."CHD_DEF_PRACY" 
   (	
      "ID_DEF_PRACY" NUMBER NOT NULL, 
	    "NAZWA_PRACY" VARCHAR2(100 BYTE) NOT NULL, 
	    "JEDNOSTKA" VARCHAR2(100 BYTE), 
	    "NORMA_MIN_H" VARCHAR2(30 BYTE), 
	    "NORMA_MAX_H" VARCHAR2(30 BYTE), 
	    "KOSZT_JEDN_PRACY" VARCHAR2(30 BYTE),
      CONSTRAINT CHD_DEF_PRACY_PK PRIMARY KEY ( ID_DEF_PRACY ) ENABLE 
   )  
...
--------------------------------------------------------
  ...
  CREATE TABLE "HD2018"."CHD_DEF_ZUZYCIA" 
   (
      "ID_DEF_ZUZYCIA" NUMBER NOT NULL, 
	    "NORMA_MIN_JEDN" VARCHAR2(30 BYTE), 
	    "NORMA_MAX_JEDN" VARCHAR2(30 BYTE), 
	    "CHD_ID_DEF_PRACY" NUMBER NOT NULL, 
	    "CHD_ID_MATERIALU" NUMBER NOT NULL,
      CONSTRAINT CHD_DEF_ZUZYCIA_PK PRIMARY KEY ( ID_DEF_ZUZYCIA ) ENABLE 
  ...
  CREATE TABLE "HD2018"."CHD_MATERIAL" 
   (	
      "ID_MATERIALU" NUMBER NOT NULL, 
	    "NAZWA_MATERIALU" VARCHAR2(100 BYTE) NOT NULL, 
	    "JEDNOSTKA" VARCHAR2(100 BYTE), 
	    "KOSZT_JEDN" VARCHAR2(30 BYTE),
      CONSTRAINT CHD_MATERIAL_PK PRIMARY KEY ( ID_MATERIALU ) ENABLE 
   )  
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT )
...
--------------------------------------------------------
  ...
  CREATE TABLE "HD2018"."CHD_PRACA" 
   (
      "ID_PRACY" NUMBER NOT NULL, 
      "CHD_ID_PRACOWNIKA" NUMBER NOT NULL, 
      ...
      CONSTRAINT CHD_PRACA_PK PRIMARY KEY ( ID_PRACY ) ENABLE
   )  
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT )
...
--------------------------------------------------------
  ...
  CREATE TABLE "HD2018"."CHD_PRACOWNIK" 
   (
      ...
      "PESEL_PRACOWNIKA" VARCHAR2(20 BYTE) NOT NULL,
      "ADRES" VARCHAR2(60 BYTE),
      CONSTRAINT CHD_PRACOWNIK_PK PRIMARY KEY ( ID_PRACOWNIKA ) ENABLE
...
BEGIN   
    --def pracy--
    DBMS_OUTPUT.PUT_LINE('def pracy');
            ...
            ELSE
                ...
                ELSE 
                    ...
                    IF rec.ZRODLO_DANYCH = 1 then
                        BEGIN
                            NULL;
                            SELECT USUNIETY INTO czy_usuwany FROM TMP_PRACOWNIK WHERE ROWNUM <=1 and PESEL_PRACOWNIKA = rec.PESEL_PRACOWNIKA and ZRODLO_DANYCH = 2;
                        EXCEPTION WHEN OTHERS THEN
                            czy_usuwany := 1;
                            DBMS_OUTPUT.PUT_LINE('BRAK INFORMACJI W DRUGIM');
                        END;
                        
                        IF czy_usuwany = 1 THEN 
                            DELETE FROM CHD_PRACOWNIK WHERE PESEL_PRACOWNIKA = rec.PESEL_PRACOWNIKA;
                        END IF;
                        
                    ELSIF rec.ZRODLO_DANYCH = 2 then
                        BEGIN
                            NULL;
                            SELECT USUNIETY INTO czy_usuwany FROM TMP_PRACOWNIK WHERE ROWNUM <=1 and PESEL_PRACOWNIKA = rec.PESEL_PRACOWNIKA and ZRODLO_DANYCH = 1;
                        EXCEPTION WHEN OTHERS THEN
                            czy_usuwany := 1;
                            DBMS_OUTPUT.PUT_LINE('BRAK INFORMACJI W PIERWSZYM');
                        END;
            ...
            ELSE
                ...
                ELSE 
                    ...
                    IF rec.ZRODLO_DANYCH = 1 then
                        BEGIN
                            NULL;
                            SELECT USUNIETY INTO czy_usuwany FROM TMP_MATERIAL WHERE ROWNUM <=1 and NAZWA_MATERIALU = rec.NAZWA_MATERIALU and ZRODLO_DANYCH = 2;
                        EXCEPTION WHEN OTHERS THEN
                            czy_usuwany := 1;
                            DBMS_OUTPUT.PUT_LINE('BRAK INFORMACJI W DRUGIM');
                        END;
                        ...
                        IF czy_usuwany = 1 THEN 
                            DELETE FROM CHD_MATERIAL WHERE NAZWA_MATERIALU = rec.NAZWA_MATERIALU;
                        END IF;
                        
                    ELSIF rec.ZRODLO_DANYCH = 2 then
                        BEGIN
                            NULL;
                            SELECT USUNIETY INTO czy_usuwany FROM TMP_MATERIAL WHERE ROWNUM <=1 and NAZWA_MATERIALU = rec.NAZWA_MATERIALU and ZRODLO_DANYCH = 1;
                        EXCEPTION WHEN OTHERS THEN
                            czy_usuwany := 1;
                            DBMS_OUTPUT.PUT_LINE('BRAK INFORMACJI W PIERWSZYM');
                        END;
    ...
    --def zuzycia--
    DBMS_OUTPUT.PUT_LINE('def zuzycia');
    ...
    LOOP
        ...
        BEGIN
            IF rec.USUNIETY = 0 then
                ...
                SELECT ID_MATERIALU INTO rec.CHD_ID_MATERIALU FROM CHD_MATERIAL WHERE ROWNUM <=1 and NAZWA_MATERIALU = rec.NAZWA_MATERIALU;
                SELECT ID_DEF_PRACY INTO rec.CHD_ID_DEF_PRACY FROM CHD_DEF_PRACY WHERE ROWNUM <=1 and NAZWA_PRACY = rec.NAZWA_PRACY;
            ...
            ELSE
                ...
                ELSE 
                    DBMS_OUTPUT.PUT_LINE('DO USUNIECIA');
                    DELETE FROM CHD_DEF_ZUZYCIA WHERE ID_DEF_ZUZYCIA = rec.ID_DEF_ZUZYCIA;
                END IF;
            END IF;
        EXCEPTION WHEN OTHERS THEN DBMS_OUTPUT.PUT_LINE(SQLCODE);
        END;
    ...
    --praca--
    DBMS_OUTPUT.PUT_LINE('praca');
    FOR rec in (SELECT ID_PRACY,CHD_ID_PRACOWNIKA,PESEL_PRACOWNIKA,DP_PRACY,DZ_PRACY,CHD_ID_DEF_PRACY,NAZWA_PRACY,KWOTA_PRACOWNIK,ILOSC,CHD_ID_MATERIALU,NAZWA_MATERIALU,ILOSC_MATERIALU,USUNIETY,ZRODLO_DANYCH,NUMER_PRZYROSTU 
            FROM TMP_PRACA ORDER BY NUMER_PRZYROSTU)
    LOOP
        SELECT CASE WHEN EXISTS ( SELECT * FROM CHD_PRACA WHERE ID_PRACY = rec.ID_PRACY) THEN 1 ELSE 0 END  INTO l_exst FROM SYS.DUAL;
        BEGIN
            IF rec.USUNIETY = 0 then

                SELECT ID_PRACOWNIKA INTO rec.CHD_ID_PRACOWNIKA FROM CHD_PRACOWNIK WHERE ROWNUM <=1 and PESEL_PRACOWNIKA = rec.PESEL_PRACOWNIKA;
                SELECT ID_DEF_PRACY INTO rec.CHD_ID_DEF_PRACY FROM CHD_DEF_PRACY WHERE ROWNUM <=1 and NAZWA_PRACY = rec.NAZWA_PRACY;
                SELECT ID_MATERIALU INTO rec.CHD_ID_MATERIALU FROM CHD_MATERIAL WHERE ROWNUM <=1 and NAZWA_MATERIALU = rec.NAZWA_MATERIALU;
                ...
                IF l_exst = 0 then
                    ...
                    INSERT INTO CHD_PRACA(ID_PRACY,CHD_ID_PRACOWNIKA,DP_PRACY,DZ_PRACY,CHD_ID_DEF_PRACY,KWOTA_PRACOWNIK,ILOSC,CHD_ID_MATERIALU,ILOSC_MATERIALU) 
                        VALUES(rec.ID_PRACY,rec.CHD_ID_PRACOWNIKA,rec.DP_PRACY,rec.DZ_PRACY,rec.CHD_ID_DEF_PRACY,rec.KWOTA_PRACOWNIK,rec.ILOSC,rec.CHD_ID_MATERIALU,rec.ILOSC_MATERIALU);

                ELSE 
                    DBMS_OUTPUT.PUT_LINE('DO UPDATE');

                    UPDATE CHD_PRACA SET CHD_ID_PRACOWNIKA=rec.CHD_ID_PRACOWNIKA,DP_PRACY=rec.DP_PRACY,DZ_PRACY=rec.DZ_PRACY,CHD_ID_DEF_PRACY=rec.CHD_ID_DEF_PRACY,KWOTA_PRACOWNIK=rec.KWOTA_PRACOWNIK,ILOSC=rec.ILOSC,CHD_ID_MATERIALU=rec.CHD_ID_MATERIALU,ILOSC_MATERIALU=rec.ILOSC_MATERIALU
                        WHERE ID_PRACY = rec.ID_PRACY;      
                END IF;
            ELSE
                IF l_exst = 0 then
                    DBMS_OUTPUT.PUT_LINE('DO IGNOROWANIA');
                ELSE 
                    DBMS_OUTPUT.PUT_LINE('DO USUNIECIA');
                    DELETE FROM CHD_PRACA WHERE ID_PRACY = rec.ID_PRACY;
                END IF;
            END IF;
        EXCEPTION WHEN OTHERS THEN DBMS_OUTPUT.PUT_LINE(SQLCODE);
        END;
...
BEGIN
  ...
  DELETE FROM STG_PRACOWNIK;
  DELETE FROM STG_MATERIAL;
  DELETE FROM STG_PRACA;

  DELETE FROM TMP_DEF_PRACY;
  DELETE FROM TMP_PRACOWNIK;
  DELETE FROM TMP_MATERIAL;
  DELETE FROM TMP_DEF_ZUZYCIA;
  DELETE FROM TMP_PRACA;
...
ALTER TABLE CHD_PRACA
ADD CONSTRAINT CHD_PRACA_FK1 FOREIGN KEY (CHD_ID_PRACOWNIKA)
REFERENCES CHD_PRACOWNIK (ID_PRACOWNIKA) ENABLE;

ALTER TABLE CHD_PRACA
ADD CONSTRAINT CHD_PRACA_FK2 FOREIGN KEY (CHD_ID_DEF_PRACY)
REFERENCES CHD_DEF_PRACY (ID_DEF_PRACY) ENABLE;

ALTER TABLE CHD_PRACA
ADD CONSTRAINT CHD_PRACA_FK3 FOREIGN KEY (CHD_ID_MATERIALU)
REFERENCES CHD_MATERIAL (ID_MATERIALU) ENABLE;

ALTER TABLE CHD_DEF_ZUZYCIA
ADD CONSTRAINT CHD_DEF_ZUZYCIA_FK1 FOREIGN KEY (CHD_ID_DEF_PRACY)
REFERENCES CHD_DEF_PRACY (ID_DEF_PRACY) ENABLE;

ALTER TABLE CHD_DEF_ZUZYCIA
ADD CONSTRAINT CHD_DEF_ZUZYCIA_FK2 FOREIGN KEY (CHD_ID_MATERIALU)
REFERENCES CHD_MATERIAL (ID_MATERIALU) ENABLE;
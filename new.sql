...
--------------------------------------------------------
  ...
  TABLESPACE "DATA" ;
--------------------------------------------------------
--  DDL for Table STG_DEF_PRACY_D
--------------------------------------------------------

  CREATE TABLE "HD2018"."STG_DEF_PRACY_D" 
   (	"ID_DEF_PRACY" NUMBER, 
	"NAZWA_PRACY" VARCHAR2(100 BYTE), 
	"JEDNOSTKA" VARCHAR2(100 BYTE), 
	"NORMA_MIN_H" NUMBER, 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ( RECORDS DELIMITED BY NEWLINE
        ...
        (
        ID_DEF_PRACY,NAZWA_PRACY,JEDNOSTKA,NORMA_MIN_H,NORMA_MAX_H,KOSZT_JEDN_PRACY,ZRODLO_DANYCH,NUMER_PRZYROSTU
        )
        )
      LOCATION
       ( 'DEF_PRACY.csv'
